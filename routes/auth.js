...
router.post("/login", async (req, res) => {
  try {
    ...
    res.json({ token, user: { id: user._id, name: user.name, role: user.role, government: user.government } });
...
router.get("/government-users", async (req, res) => {
  try {
    const users = await User.find({ role: "government" }).select("name email phone government");
